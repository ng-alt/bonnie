EXES=bonnie++ zcav zcav

all: $(EXES)

SCRIPTS=bon_csv2html bon_csv2txt

prefix=/home/rjc/debian/bonnie++-1.02e/debian/bonnie++/usr
eprefix=${prefix}
...
install: install-bin
	mkdir -p /home/rjc/debian/bonnie++-1.02e/debian/bonnie++/usr/share/man/man1 /home/rjc/debian/bonnie++-1.02e/debian/bonnie++/usr/share/man/man8
	${INSTALL} -m 644 $(MAN1) /home/rjc/debian/bonnie++-1.02e/debian/bonnie++/usr/share/man/man1
	${INSTALL} -m 644 $(MAN8) /home/rjc/debian/bonnie++-1.02e/debian/bonnie++/usr/share/man/man8
